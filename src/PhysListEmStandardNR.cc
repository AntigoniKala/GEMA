...
void PhysListEmStandardNR::ConstructProcess()
{
    ...
    G4double RecoilCutOff = 100. * eV;
    G4double PhysicsCutOff = 10. * eV;
    G4ScreenedNuclearRecoil *nucr = new G4ScreenedNuclearRecoil();
    // G4ScreenedNuclearRecoil *nucr = new G4ScreenedNuclearRecoil("ScreenedElastic", "zbl", 1, RecoilCutOff, PhysicsCutOff);
    G4double energyLimit = 100. * MeV;
    nucr->SetMaxEnergyForScattering(energyLimit);
    // nucr->SetRecoilCutoff(RecoilCutOff);
    // nucr->SetPhysicsCutoff(PhysicsCutOff);
